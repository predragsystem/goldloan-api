...
! function(a) {
    ...
    ! function(a) {
        ...
        a.fn.inputVal = function(b) {
            ...
            return c.is("input, textarea, select") ? "undefined" == typeof b ? d[c.attr("name")].get() : (d[c.attr("name")].set(b), c) : "undefined" == typeof b ? o(d, "get") : (g(b, function(a, b) {
                d[b].set(a)
            }), c)
        ...
        return c = c || {}, a(this).each(function() {
            var d = a(this),
                ...
                p = a(this).find("[data-repeater-item]").first().find("[data-repeater-delete]");
            c.isFirstItemUndeletable && p && p.remove();
            var q = function() {
                    var a = i.data("repeater-list");
                ...
                t = function(b, c, d) {
                    b.each(function(b) {
                        ...
                        e.data("item-name", c + "[" + b + "]"), k(e.find("[name]"), d).each(function() {
                            ...
                            f.attr("name", j), s(d, e, function(d) {
                                var e = a(this);
                                t(k(e.find("[data-repeater-item]"), d.repeaters || []), c + "[" + b + "][" + e.find("[data-repeater-list]").first().data("repeater-list") + "]", d.repeaters)
                            })
                        })
            ...
            var u = function() {
                    var d = function(c, e, f) {
                        if (e) {
                            var g = {};
                            k(c.find("[name]"), f).each(function() {
                                var b = a(this).attr("name").match(/\[([^\]]*)(\]|\]\[\])$/)[1];
                                g[b] = a(this).attr("name")
                ...
                v = function() {
                    var a = o.clone();
                    u(a), c.repeaters && r(a), e.call(a.get(0))
                };
