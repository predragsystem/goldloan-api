...
$(document).ready(function() {
    $("#basic-alert").on("click", function() {
        ...
        swal({
            ...
            imageUrl: "../../../app-assets/images/icons/thumbs-up.jpg"
        })
        ...
        swal({
            ...
            return inputValue !== !1 && ("" === inputValue ? (swal.showInputError("You need to write something!"), !1) : void swal("Nice!", "You wrote: " + inputValue, "success"))
        })
        ...
        swal({
            ...
            isConfirm ? swal("Changed!", "Confirm button text was changed!!", "success") : swal("Cancelled", "It's safe.", "error")
        })
